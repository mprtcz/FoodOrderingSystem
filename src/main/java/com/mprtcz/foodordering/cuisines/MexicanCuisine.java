...
public class MexicanCuisine implements Cuisine {
    ...
    private void createMainCourseList(){
        ...
        mainCourseList.add(new MainCourse("Mexican Meal 1", 1.99));
        mainCourseList.add(new MainCourse("Mexican Meal 2", 2.99));
        mainCourseList.add(new MainCourse("Mexican Meal 3", 1.29));
        mainCourseList.add(new MainCourse("Mexican Meal 4", 2.29));
        mainCourseList.add(new MainCourse("Mexican Meal 5", 3.99));
        mainCourseList.add(new MainCourse("Mexican Meal 6", 2.44));
        mainCourseList.add(new MainCourse("Mexican Meal 7", 5.99));
        mainCourseList.add(new MainCourse("Mexican Meal 8", 2.55));
    }

    private void createDessertsList(){
        dessertsList = new ArrayList<>();
        dessertsList.add(new Dessert("Mexican Dessert 1", 1.99));
        dessertsList.add(new Dessert("Mexican Dessert 2", 2.99));
        dessertsList.add(new Dessert("Mexican Dessert 3", 1.29));
    }
}
